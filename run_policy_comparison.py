...
if __name__ == '__main__':
    ...
    visualize_policy(pi_policy, ENV_NAME, pi_env.desc.shape, 'Optimal policy - Modified transition model')
    visualize_value(pi_V, ENV_NAME, pi_env.desc.shape, 'Value estimates - Modified transition model')
